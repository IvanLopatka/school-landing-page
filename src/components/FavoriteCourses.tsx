...
export const FavoriteCourses: FC<FavoriteCoursesProps> = ({
  ...
  return (
    <div
      key={iconTitle}
      className="z-10 container flex h-[210px] flex-col shadow-sm sm:h-[420px]"
    >
      <div className="relative h-full w-full">
        <Image
          ...
          src={iconUrl}
          alt={iconAlt}
          className="z-5 mb-5 object-cover"
        />
        <div className="absolute top-0 right-0 bottom-0 left-0 z-10 h-full w-full bg-black/50">
